...
public class GripPipeline implements VisionPipeline { //gorillaGRIP
	...
	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {0.0, 26.416386646622303};
		double[] hsvThresholdSaturation = {157.46403169288908, 255.0};
		double[] hsvThresholdValue = {146.76259539539006, 255.0};
		hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, hsvThresholdOutput);

		// Step Blur0:
		Mat blurInput = hsvThresholdOutput;
		BlurType blurType = BlurType.get("Box Blur");
		double blurRadius = 38.43843872482712;

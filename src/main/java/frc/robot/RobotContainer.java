 ...
 private final static WPI_TalonFX lowerLeftMotor = new WPI_TalonFX(Constants.DriveConstants.LOWER_LEFT_MOTOR);
  ...
  private void configureButtonBindings() {
    enableLimey.whenPressed(
      ...
      verticalIndexerButton.whileHeld(new InstantCommand(indexerSubsystem::enableVerticalIndexer, indexerSubsystem));

      raiseIntakeButton.whenPressed(new InstantCommand(indexerSubsystem::raiseIntake, indexerSubsystem));
